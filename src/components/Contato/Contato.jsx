            ...
            <main>
                <section id="contato">
                    ...
                    <form action="https://api.staticforms.xyz/submit" method="post">
                        <label>Nome</label>
                        <input required type="text" name="name" placeholder="Digite seu nome" autocomplete="off" />
                        <label>Email</label>
                        <input required type="email" name="email" placeholder="Digite seu email" autocomplete="on" />
