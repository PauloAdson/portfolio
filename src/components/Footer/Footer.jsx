          ...
          <nav className="footer_nav">
            <div className="footer_nav-links-sociais">
              ...
              <ul className="lista-links-sociais">
                <a
                  href="https://www.linkedin.com/in/paulo-adson"
                  target="_blank"
                  rel="noopener"
                >
                ...
                <a
                  href="https://www.instagram.com/oluap_dev/"
                  target="_blank"
                  rel="noopener"
                >
                ...
                <a
                  href="https://www.facebook.com/profile.php?id=100077998817978"
                  target="_blank"
                  rel="noopener"
                >
            ...
            <ul className="footer_links-container">
              ...
              <li>
                <a href="/portfolio/#sobre" rel="noopener">
                  Sobre
                </a>
              </li>
              <li>
            ...
            <ul className="footer_links-container">
              ...
              <li>
                <a
                  href="https://wa.me/62995132226?text=Ol%C3%A1%2C%20gostaria%20de%20realizar%20um%20or%C3%A7amento."
                  target="_blank"
                  rel="noopener"
                >
              ...
              <li>
                <a
                  href="mailto:paulo.alves200581@gmail.com"
                  target="_blank"
                  rel="noopener"
                >
